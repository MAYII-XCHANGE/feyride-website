  ...
  home: {
    ...
    guest: {
      ...
      features: [
        ...
        { title: 'Verified Drivers', desc: 'Bank-level verification for every rider' },
    ...
    comfort: {
      ...
      host: {
        ...
        desc: 'Premium features for Riders',
        1: { title: 'High Visibility', desc: 'Featured in app for quality drivers' },
        2: { title: 'Loyalty Rewards', desc: 'Earn bonus for consistent route posting' },
